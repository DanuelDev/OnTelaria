...
<section id="sobre">
  <div class="container">
    ...
    <div class="cards">
      ...
      <div class="card">
        <div class="icone"><i class="bi bi-trophy-fill"></i></div>
        <div class="numero">15+</div>
        <div class="label">Prêmios</div>
      </div>
      
      <div class="card">
        <div class="icone"><i class="bi bi-clock-history"></i></div>
        <div class="numero">24/7</div>
        <div class="label">Atendimento</div>
      </div>
      
      <div class="card">
        <div class="icone"><i class="bi bi-geo-alt"></i></div>
...
<section id="quartos">
  ...
  <div class="quartos-grid">
    ...
    <div class="quarto-card">
      <img src="https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=800" alt="Suíte" class="quarto-imagem">
      <div class="quarto-conteudo">
        ...
        <div class="quarto-detalhes">
          <div class="detalhe-item"><i class="bi bi-house-door-fill"></i> <span>30m²</span></div>
          <div class="detalhe-item"><i class="bi bi-people-fill"></i> <span>3 pessoas</span></div>
          <div class="detalhe-item"><i class="bi bi-wifi"></i> <span>Wi-Fi Grátis</span></div>
        </div>
    ...
    <div class="quarto-card">
      ...
      <div class="quarto-conteudo">
        ...
        <div class="quarto-detalhes">
          <div class="detalhe-item"><i class="bi bi-house-door-fill"></i> <span>45m²</span></div>
          <div class="detalhe-item"><i class="bi bi-people-fill"></i> <span>4 pessoas</span></div>
          <div class="detalhe-item"><i class="bi bi-wifi"></i> <span>Wi-Fi Grátis</span></div>
        </div>
    ...
    <div class="quarto-card">
      ...
      <div class="quarto-conteudo">
        ...
        <div class="quarto-detalhes">
          <div class="detalhe-item"><i class="bi bi-house-door-fill"></i> <span>65m²</span></div>
          <div class="detalhe-item"><i class="bi bi-people-fill"></i> <span>4 pessoas</span></div>
          <div class="detalhe-item"><i class="bi bi-wifi"></i> <span>Wi-Fi Grátis</span></div>
        </div>
    ...
    <!-- Luxo Casal -->
    <div class="quarto-card">
      <img src="https://images.unsplash.com/photo-1590490360182-c33d57733427?w=800" alt="Luxo Casal" class="quarto-imagem">
      <div class="quarto-conteudo">
        ...
        <div class="quarto-detalhes">
          <div class="detalhe-item"><i class="bi bi-house-door-fill"></i> <span>20m²</span></div>
          <div class="detalhe-item"><i class="bi bi-people-fill"></i> <span>2 pessoas</span></div>
          <div class="detalhe-item"><i class="bi bi-wifi"></i> <span>Wi-Fi Grátis</span></div>
        </div>
    ...
    <div class="quarto-card">
      ...
      <div class="quarto-conteudo">
        ...
        <div class="quarto-detalhes">
          <div class="detalhe-item"><i class="bi bi-house-door-fill"></i> <span>75m²</span></div>
          <div class="detalhe-item"><i class="bi bi-people-fill"></i> <span>5 pessoas</span></div>
          <div class="detalhe-item"><i class="bi bi-wifi"></i> <span>Wi-Fi Grátis</span></div>
        </div>
    ...
    <!-- Apartamento mini -->
    <div class="quarto-card">
      <img src="https://images.unsplash.com/photo-1590490360182-c33d57733427?w=800" alt="Apartamento mini" class="quarto-imagem">
      <div class="quarto-conteudo">
        ...
        <div class="quarto-detalhes">
          <div class="detalhe-item"><i class="bi bi-house-door-fill"></i> <span>100m²</span></div>
          <div class="detalhe-item"><i class="bi bi-people-fill"></i> <span>6 pessoas</span></div>
          <div class="detalhe-item"><i class="bi bi-wifi"></i> <span>Wi-Fi Grátis</span></div>
        </div>
